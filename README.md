...
To run app please configure a .env file on root of project, the required variable should be named 'REACT_APP_GITHUB_API' (whitout quotes '') and assign a github personal access token
